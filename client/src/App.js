...
import ForgotPassword from "./Components/Auth/ForgotPassword"; // Import Forgot Password component
import "./App.css";
            ...
            <Routes>
                <Route path="/" element={<Navbar logIn={loggedIn} user={loggedIn && user.latitude ? "bank" : "user"} />}>
                    ...
                    {!loggedIn && <>
                        ...
                        <Route path="/forgot-password/:handle" element={<ForgotPassword />} /> {/* Added route */}
                    </>}
