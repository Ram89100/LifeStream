...
const Auth = (props) => {
    ...
    useEffect(() => {
        ...
        mapboxgl.accessToken = process.env.MAP_BOX_ID;
    ...
    const signUp = async (e) => {
        ...
        await axios.post(`${process.env.REACT_APP_BACKEND_URL}/auth/${handle}`, formData, { withCredentials: true }).then(async (res) => { }, (err) => alert(err.response.data.errorMessage));
        await getLoggedIn();
                                ...
                                <><div><label className="font-semibold  leading-8">Username:<font color="red">*</font></label>
                                    ...
                                    <p className="text-center mt-2">
                                        <button
                                            ...
                                            onClick={() => navigate(`/forgot-password/${handle}`)}
                                        >
                                            Forgot Password?
                                        </button>
                                    </p>
